...
$(document).ready(function () {
  ...
  function get_achievement() {
    ...
    //↓★★★★★★
      ...
      return "B";  // もし「averageIndicate」が60以上なら"B"を返します。
    } else if (averageIndicate >= 40) {
      return "C";  // もし「averageIndicate」が40以上なら"C"を返します。
    } else {
  ...
  function get_pass_or_failure() {
    ...
    let judge = "合格";
    //↓★★★★★★
    for (let i=0; i<number; i++) {     // ヒント：配列の繰り返し処理について調べてみましょう。
    if(subject_points[i]<60) {     // 入力したそれぞれの教科のうち、1つでも60点よりも低い点数があった場合、変数「judge」に"不合格"を再代入する処理を記述する。
        judge= "不合格";
        break;
      }
    }
